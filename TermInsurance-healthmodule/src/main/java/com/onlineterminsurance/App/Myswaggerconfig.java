...
public class Myswaggerconfig {
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("HealthModule").description("API reference guide for developers").termsOfServiceUrl("https://www.javacodegeeks.com/").contact("Batra, Yatin").version("1.0").build();	
	}
}
